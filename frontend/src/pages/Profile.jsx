...
const Profile = () => {
    ...
    return (
        <main className="x_profile_page">
            ...
            <section className="x_profile_container">
                ...
                <div className="x_profile_content">
                                            ...
                                            <div className="x_profile_info_grid">
                                                ...
                                                <div className="x_profile_info_card_new">
                                                    ...
                                                    <div className="x_info_card_content">
                                                        ...
                                                        <p className="x_profile_value">{userData.address}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="x_profile_info_card_new">
                                                    ...
                                                    <div className="x_info_card_content">
                                                        ...
                                                        <p className="x_profile_value">{userData.joinDate}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="x_profile_tab">
                            ...
                            {bookings.length > 0 ? (
                                        ...
                                        >
                                            <div className="x_booking_header">
                                                <div className="x_booking_date">
                                                    ...
                                                    <div>
                                                        <p className="x_booking_date_text">{booking.date}</p>
                                                ...
                                                <div className="x_booking_status">
                                                    <span
                                                        className={`x_status_badge ${booking.status}`}
                                                    >
                                ...
                                <div className="x_empty_state">
                                    ...
                                    <button className="x_new_booking_btn">Make a Reservation</button>
                                </div>
                            )}
                    ...
                    {activeTab === 'changepassword' && (
                        <div className="x_profile_tab">
                            <div className="x_change_password_header">
                                <div className="x_change_password_icon">
                                    <Lock size={32} />
                                </div>
                                <div>
                            ...
                            <div className="x_change_password_section">
                                ...
                                <form className="x_change_password_form">
                                    ...
                                    <div className="x_password_divider"></div>
                                    ...
                                    <div className="x_change_password_group">
                                        ...
                                        />
                                        <p className="x_password_hint">Use at least 8 characters with uppercase, lowercase, and numbers</p>
                                    </div>
            ...
            {showChangePassword && (
                <div className="x_modal_overlay" onClick={() => setShowChangePassword(false)}>
            ...
            {showLogoutConfirm && (
                <div className="x_modal_overlay" onClick={() => setShowLogoutConfirm(false)}>
                    <div className="x_modal_content x_logout_modal" onClick={(e) => e.stopPropagation()}>
                        <div className="x_logout_modal_icon">
                            <LogOut size={48} />
                        </div>
                        <h3>Sign Out of Your Account?</h3>
                        <p>Are you sure you want to logout? You'll need to sign in again to access your profile and bookings.</p>
