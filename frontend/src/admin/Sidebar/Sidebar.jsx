...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <MdLocalBar />,
        label: "Bar & Drinks",
        roles: ["chef", "manager", "superadmin", "bartender"],
      },
      {
        to: `${ADMIN_BASE}/categories`,
        icon: <MdLocalDining />,
        label: "Categories & Cuisines",
        roles: ["chef", "manager", "superadmin"],
      },
      {
        to: `${ADMIN_BASE}/inventory`,
        icon: <MdInventory2 />,
        label: "Kitchen Stock",
        roles: ["chef", "manager", "superadmin"],
      },
  ...
  },
  {
    ...
    items: [
      {
        to: `${ADMIN_BASE}/tables`,
        icon: <MdTableRestaurant />,
        label: "Table Status",
        roles: ["waiter", "manager", "superadmin"],
      },
      {
        to: `${ADMIN_BASE}/take-order`,
        icon: <MdCountertops />,
        label: "Take New Order",
        roles: ["waiter", "manager", "superadmin"],
      },
      {
        to: `${ADMIN_BASE}/service-requests`,
